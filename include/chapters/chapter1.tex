...
Поскольку требования к потребляемой мощности не слишком жёсткие, выберем рекомендуемое для большинства ОУ номинальное напряжение источника питания $U_п = \pm 15 \text{ В}$.
...
4. Согласно справочным данным выберем ОУ типа К154УД4 (ближайшим иностранным аналогом является Hitachi HA2520) c параметрами:
\begin{itemize}
    \item $K = 8000$
    \item $v_u = 400 \text{ В/мкс}$
    \item $f_1 = 30 \text{ МГц}$
    \item $U_\text{вых. max} = 10 \text{ В}$
    \item $I_{пот} = 7 \text{ мА}$
...
Таким образом, ПУ может быть выполнен на ОУ типа К154УД4, число каскадов $n = 2$, $|\delta K_R| \le 0.39 \text{ \%}$.
